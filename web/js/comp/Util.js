...
(function (ha) {
    ...
    (function (comp) {
        class Util {
            ...
            getEl(query, parent = null, err = true) {
                let el;
                if (!parent)
            ...
            async AjaxLogin(type, urlServer, dataStr, loginUrl, pf = null) {
                let xml;
            ...
            async Ajax2(type, url, dataStr, pf = null) {
            ...
            async Ajax(type, url, dataStr, pf = null) {
