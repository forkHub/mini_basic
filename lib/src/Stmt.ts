namespace ha.parse {
    class Stmt {
        ...
        forPendek(): boolean {
            ...
            //for exp = exp to exp
            //1   2   3 4   5  6
            function check(t1: Itoken, t2: Itoken, t3: Itoken, t4: Itoken, t5: Itoken, t6: Itoken): boolean {
